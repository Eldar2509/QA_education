...
let item_7 = String(item_6); // 22. Создать переменную item_7 и в ней преобразовать item_6 в String. 22. Создать переменную item_7 и в ней преобразовать item_6 в String.
...
const checkAge = function (age) {
    age = Number(age)
    if (!isNaN(age)) {
        if (age < 18) { // 29. Создать if в котором будите проверять значение переменной age_1
            console.log('You don\'t have access cause your age is ' + age + ' It\'s less then'); // 30. Если age_1 < age_2, вывести в консоль “You don’t have access cause your age is ” + age_1 + “ It’s less then ”
        }
        else if (age >= 18 && age < 60) { // 31. Если age_1 >=  age_2 и age_1 <  age_3, вывести в консоль “Welcome  !”
            console.log('Welcome!');
        }
        else if (age > 60) { // 32. Если age_1  > age_3, вывести в консоль “Keep calm and look Culture channel”.
            console.log('Keep calm and look Culture channel');
        }
        else {
            console.log('Technical work'); // 33. Иначе выводите “Technical work”.
